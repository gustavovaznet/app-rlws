...
<html lang="pt-br">
  ...
  <body>
    ...
    <nav class="navbar navbar-fixed navbar-dark bg-dark navbar-expand-lg navbar-light bg-light">
      <div class="container">
        <!-- LOGO -->    
        <a class="navbar-brand bold" href="main.php"><img class="logo" src="img/logo.png">Sistema Web</a>
        <!-- NAVBAR TOGGLE -->     
    ...
    <nav class="navbar fixed-bottom navbar-dark bg-dark navbar-expand-lg navbar-light bg-light">
      <div class="container">
        ...
        <!-- LOGO -->    
        <a class="navbar-brand bold" href="main.php"><img class="logo" src="img/logo.png">Sistema Web - Todos os direitos reservados</a>   
        </ul> 
      </div>    
    </nav>
    </header>
