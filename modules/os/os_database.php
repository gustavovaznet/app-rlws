...
<html lang="pt-br">
  <head>
    ...
    <!-- JAVASCRIPT FOR DELETE, CLOSE AND UPDATE OS'S -->
    <script>      
      //DELETE FUNCTION
      function delet(id){
        location.href = 'os_database.php?action=delete&id=' + id;
      }
      //OS CLOSE FUNCTION
      function osClose(id){
        location.href = 'os_database.php?action=osClose&id=' + id;
      }
      //UPDATE FUNCTION
      function update(id, txt_name, description, txt_value, txt_service){

        let form = document.createElement('form')
        form.action = 'os_controller.php?pag=open&action=update'
        form.method = 'post'
        form.className = 'row'
  ...
  <body>
    ...
    <nav class="navbar bold navbar-dark bg-dark navbar-expand-lg navbar-light bg-light">
      <div class="container">
        <!-- LOGO -->
        <a class="navbar-brand" href="../../main.php"><img class="logo" src="../../img/logo.png">Sistema Web</a>
        <!-- NAVBAR TOGGLE -->     
          ...
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="os_database.php">Ordens de Serviço</a></li>
              </ol>
            </nav>
          </div>
          <div class="col-md-12">
